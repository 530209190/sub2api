...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// 全局用户计费倍率
		adminSettings.GET("/user-billing-multiplier", h.Admin.Setting.GetUserBillingMultiplierSettings)
		adminSettings.PUT("/user-billing-multiplier", h.Admin.Setting.UpdateUserBillingMultiplierSettings)
		// 529过载冷却配置
