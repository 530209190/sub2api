export default {
  ...
  admin: {
    ...
    groups: {
      ...
      userBillingSettings: {
        button: 'Global Billing',
        title: 'Global Billing Multiplier',
        enabled: 'Enable global billing multiplier',
        enabledHint: 'When enabled, every user charge is multiplied after the group/user-specific multiplier.',
        multiplier: 'Multiplier',
        multiplierHint: '0 makes this layer free, 1 keeps the current price, 2 doubles overall billing.',
        effectivePreview: 'Current extra multiplier',
        disabledPreview: 'Disabled. The global multiplier is not applied.',
        invalidMultiplier: 'Multiplier must be greater than or equal to 0',
        loadFailed: 'Failed to load global billing multiplier',
        saveSuccess: 'Global billing multiplier saved',
        saveFailed: 'Failed to save global billing multiplier'
      },
    ...
    accounts: {
      ...
      anthropic: {
        ...
        supportsImageInputDesc:
          'Only applies to Anthropic API Key accounts. Enabled by default; when disabled, image requests skip this account.',
        webSearchEmulation: 'Web Search Emulation',
  ...
  onboarding: {
    ...
    user: {
      ...
      keySubmit: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click to confirm and create your API key.</p><div style="padding: 8px 12px; background: #fee2e2; border-left: 3px solid #ef4444; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚠️ Important:</b><ul style="margin: 8px 0 0 16px;"><li>Copy the key (zc-xxx) immediately after creation</li><li>Key is only shown once, need to regenerate if lost</li></ul></div><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>🚀 How to Use:</b><br/>Configure the key in any OpenAI-compatible client (like ChatBox, OpenCat, etc.) and start using!</p><p style="margin-top: 12px; color: #10b981; font-weight: 600;">👉 Click "Create" button</p></div>'
      }
    }
  },
